...
const STAMPS_CONFIG = [
  {
    ...
    image: './assets/shark-bite.PNG?v=3',
    color: '#1565C0',
    emoji: '🦈',
  },
  {
    ...
    image: './assets/namazu-chan.PNG?v=3',
    color: '#283593',
    emoji: '🐟',
  },
  {
    ...
    image: './assets/real-shark.PNG?v=3',
    color: '#0D47A1',
    emoji: '🦈',
  },
  {
    ...
    image: './assets/mitsuwa-chan.PNG?v=3',
    color: '#B71C1C',
    emoji: '⛩️',
  },
  {
    ...
    image: './assets/tochiko-chan.heic?v=3',
    color: '#E65100',
    emoji: '👧',
  },
];
